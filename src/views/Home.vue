    ...
    <body id="page-top">
      ...
      <section class="page-section portfolio" id="portfolio">
        <div class="container">
          ...
          <div class="row justify-content-center">
              <div v-for="(cicla, i) in ArrayBicicletas" :key="i" class="col-12 col-md-6 col-lg-4">
                  <img src="https://tubici.com/wp-content/uploads/2019/12/TUBICI-BIKE-SHOP-GW-HYENA-AZUL-PETROLEO-NEON-1-1.jpg" alt="" class="img-fluid">
                  <h1>{{ cicla.nombre }}</h1>
                  <p>{{ cicla.referencia }}</p>
                  <p>{{ cicla.color }}</p>
                  <p>{{ cicla.tamaño }}</p>
                  <p>{{ cicla.precio }}</p>
