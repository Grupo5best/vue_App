...
>
      ...
      <section class="page-section portfolio" id="portfolio">
        <div class="container">
          ...
          <div class="row justify-content-center">
              <div v-for="(bicicleta,i) in ArrayBicicletas" :key="i" class="col-md-6 col-lg-4 mb-5">
              <div
                class="portfolio-item mx-auto"
                data-bs-toggle="modal"
                :data-bs-target="'#'+bicicleta.referencia"
              >
                <div
                  class="
      ...
      <!-- Portfolio Modal 1-->
      <div
        v-for="(bicicleta, i) in ArrayBicicletas" :key="i"
        class="portfolio-modal modal fade"
        :id="bicicleta.referencia"
        tabindex="-1"
